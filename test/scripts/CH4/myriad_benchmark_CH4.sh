...
cp $TROVE_DIR/test/benchmarks/CH4/input/*.inp $TMPDIR
cp $TROVE_DIR/test/scripts/CH4/run_benchmark.sh $TMPDIR
cp $TROVE_DIR/test/scripts/CH4/myriad_benchmark_CH4.sh $TMPDIR
